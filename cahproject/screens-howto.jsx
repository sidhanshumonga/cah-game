// Point Blank — How to Play screen

function HowToPlay({ onBack, onCreate }) {
  const steps = [
    {
      ...
      art: (
        <div className="howto-art howto-art-players">
          {window.GAME_DATA.bots.slice(0, 4).map((b, i) => (
  ...
  return (
    <div className="screen create-screen" data-screen-label="How to Play">
      ...
      <div className="create-body howto-body">
        <h2 className="create-title howto-title">How to play</h2>
        ...
        <div className="howto-cta">
          ...
          <Btn big={true} variant="secondary" onClick={onBack}>Back</Btn>
        </div>
      </div>
    </div>
  );
